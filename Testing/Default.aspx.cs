...
namespace Testing
{
    ...
    {
        protected string googleplus_client_id = "1041542083134-qudsmfl3pt5thukdo7b6ue2ksj5vv571.apps.googleusercontent.com";    // Replace this with your Client ID
        protected string googleplus_client_secret = "1ng2-ik8-7Dn6g4EHvMLmoUp";                                                // Replace this with your Client Secret
        protected string googleplus_redirect_url = "http://localhost:57330/Home.aspx";                                         // Replace this with your Redirect URL; Your Redirect URL from your developer.google application should match this URL.
